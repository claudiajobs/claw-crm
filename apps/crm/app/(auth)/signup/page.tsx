      ...
      >
        ...
        >
          ...
          <div style={{ marginBottom: 32, textAlign: 'center' }}>
            ...
            <h1 style={{ fontSize: 22, fontWeight: 700, color: 'var(--color-gray-800)', marginBottom: 4 }}>Crie sua conta</h1>
            <p style={{ fontSize: 13, color: 'var(--color-gray-400)' }}>Comece a usar o sevende</p>
          </div>
